...
<div class="space-y-6">
    ...
    @if (! $showOtpInput)
        <form wire:submit="sendOtp" class="space-y-5" novalidate>
            <div>
                <label for="telegram_chat_id" class="block text-sm font-medium leading-5 text-surface-700 mb-1.5">
                    {{ __('auth.telegram_chat_id') }}
                </label>
                <input
                    wire:model.blur="telegram_chat_id"
                    id="telegram_chat_id"
                    type="text"
                    required
                    autocomplete="off"
