...
class Icon extends Component
{
    ...
    protected function iconGoogle(): string
    {
        return '<svg class="'.e($this->class).'" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    protected function iconGithub(): string
    {
        return '<svg class="'.e($this->class).'" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    protected function iconFacebook(): string
    {
        return '<svg class="'.e($this->class).'" fill="#1877F2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
        </svg>';
    }

    protected function iconTwitter(): string
    {
        return '<svg class="'.e($this->class).'" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    protected function iconLinkedin(): string
    {
        return '<svg class="'.e($this->class).'" fill="#0A66C2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
        </svg>';
    }

    protected function iconGitlab(): string
    {
        return '<svg class="'.e($this->class).'" fill="#E24329" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M23.955 13.587a1.11 1.11 0 0 0-.034-.09l-2.32-6.19a.834.834 0 0 0-.044-.12l-2.51-6.7a.943.943 0 0 0-1.797 0l-2.51 6.7H8.44l-2.51-6.7a.943.943 0 0 0-1.797 0l-2.51 6.7a.54.54 0 0 0-.044.12l-2.32 6.19a1.11 1.11 0 0 0 .403 1.262l10.996 7.98a.52.52 0 0 0 .616 0l10.996-7.98a1.11 1.11 0 0 0 .403-1.262z"/>
        </svg>';
    }

    protected function iconMicrosoft(): string
    {
        return '<svg class="'.e($this->class).'" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    public function render(): View|Closure|string
    {
        return function (array $data) {
            $svg = match ($this->name) {
                ...
                'google' => $this->iconGoogle(),
                'github' => $this->iconGithub(),
                'facebook' => $this->iconFacebook(),
                'twitter' => $this->iconTwitter(),
                'linkedin' => $this->iconLinkedin(),
                'gitlab' => $this->iconGitlab(),
                'microsoft' => $this->iconMicrosoft(),
            ...
            return match ($this->name) {
                'google', 'github', 'facebook', 'twitter', 'linkedin', 'gitlab', 'microsoft' => $svg, // social icons include their own <svg> wrapper
                default => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="'.e($this->class).'">'.$svg.'</svg>',
            };
        };
    }
}
